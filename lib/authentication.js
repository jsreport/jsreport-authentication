...
function addPassport (reporter, app, admin, definition) {
  ...
  passport.deserializeUser((id, done) => {
    ...
    Promise.resolve(reporter.authentication.usersRepository.find(id)).asCallback(done)
  })
...
module.exports = function (reporter, definition) {
  ...
  if (
    ...
    throw new Error('authentication extension options validation error: cookieSession.secret option is required')
  }
